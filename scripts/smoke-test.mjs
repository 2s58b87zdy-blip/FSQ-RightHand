...
assert.match(pageSource, /className="atlasSmartWelcome"/);
assert.match(pageSource, /className="atlasSmartAsk"/);
...
assert.match(stylesSource, /\.atlasSmartCore\{/);
assert.match(stylesSource, /@media\(max-width:520px\)\{\.atlasSmartIdentity/);
