...
async function config() {
  ...
  if (!server || !database) throw new Error('Azure SQL is not configured. Set SQL_SERVER and SQL_DATABASE.');
  ...
  if (process.env.SQL_USER && process.env.SQL_PASSWORD) {
    return { ...common, user: process.env.SQL_USER, password: process.env.SQL_PASSWORD };
  }
